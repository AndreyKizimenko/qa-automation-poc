...
test.describe('Dashboard load times', () => {
  test('Platform cards', async ({ dashboard, loadtestFleetId, page }, testInfo) => {
  ...
  test('Software block', async ({ dashboard, loadtestFleetId, page }, testInfo) => {
    await dashboard.goto({ fleetId: loadtestFleetId });
  ...
  test('Activity block', async ({ dashboard, page }, testInfo) => {
  ...
  test('Filter by macOS', async ({ dashboard, loadtestFleetId, page }, testInfo) => {
  ...
  test('Filter by Windows', async ({ dashboard, loadtestFleetId, page }, testInfo) => {
  ...
  test('Filter by Linux', async ({ dashboard, loadtestFleetId, page }, testInfo) => {
